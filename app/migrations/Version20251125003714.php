 ...
 */
final class Version20251125003714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD category VARCHAR(100) DEFAULT NULL, ADD reading_time INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP category, DROP reading_time');
    }
}
